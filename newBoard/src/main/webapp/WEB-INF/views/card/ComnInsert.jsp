...
<!-- 		<link rel="stylesheet" href="/bootstrap-3.3.2-dist/css/default.css"> -->
			...
			<div id="test" style="display:block;">
				<table class="table table-bordered" border=1 style="width:600px; margin-top:-20px">
					<tr>
						...
						<!-- 참석자 입력란 -->			
						<td>
						<div id="comnctnAtnd" style="float:left; width:650px">						
						    <select id="antd" name="dd"  multiple class="demo-default">
								<c:forEach items="${selectMemList}" var="item">
									<option value="${item.memSeq}">${item.memName}</option>
								</c:forEach>
							</select>
							<script>
							$('#antd').selectize({
